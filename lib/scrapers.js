...
const scrape = {
    ...
    receivedTransactions: (html) => {
        return scrape.transactions(html, 'received');
    },

    sentTransactions: (html) => {
        return scrape.transactions(html, 'sent');
    },

    allTransactions: (html) => {
        let received = scrape.transactions(html, 'received');
        let sent = scrape.transactions(html, 'sent');
